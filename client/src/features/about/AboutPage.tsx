...
import { useLazyGet400ErrorQuery, useLazyGet401ErrorQuery, useLazyGet404ErrorQuery, useLazyGet500ErrorQuery, useLazyGetValidationErrorsQuery } from "./errorApi";
...
export default function AboutPage() {
  ...
  const [triggerValidationError] = useLazyGetValidationErrorsQuery();
